...
> **Last Updated:** 2026-07-23 (R4 Phase 2 — writer/verifier trust core, unified ranked feed, claims-fed Ask Journal/reports — shipped, writer dark (`LLM_WRITER_ENABLED = false`), flag-gated OFF; R4 Phase 1 canonical claim store + evidence rails, R3 Personal Experiments, and Michael's review hardening pass (GR1/GR2/EX1/EX2) remain complete, flag-gated OFF)
