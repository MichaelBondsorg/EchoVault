...
const WeeklyReport = ({ text, onClose }) => (
  <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
    <div className="bg-white dark:bg-hearth-900 rounded-2xl p-6 max-w-md w-full shadow-2xl dark:shadow-none dark:ring-1 dark:ring-hearth-700 relative max-h-[80vh] overflow-y-auto flex flex-col">
