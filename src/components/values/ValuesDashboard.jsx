  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold text-warm-900">Value Alignment</h2>
      ...
      {report?.overallMessage && (
        <motion.div
          ...
          className="p-4 bg-gradient-to-r from-warm-50 to-rose-50 rounded-xl border border-warm-200"
        >
      ...
      <div className="bg-white rounded-2xl border border-warm-200 p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-medium text-warm-800">Values Overview</h3>
          <button
      ...
      {trends?.available && (
        <div className="bg-white rounded-2xl border border-warm-200 p-4">
          <h3 className="font-medium text-warm-800 mb-3">Recent Trends</h3>
            ...
            <div className="text-center">
              ...
              <div className="space-y-1">
                {trends.improving.slice(0, 2).map(v => (
                  <span key={v} className="block text-xs font-medium text-green-700">
            ...
            <div className="text-center">
              ...
              <div className="space-y-1">
                {trends.declining.slice(0, 2).map(v => (
                  <span key={v} className="block text-xs font-medium text-red-600">
                    {CORE_VALUES[v]?.label.split(' ')[0]}
                  </span>
                ))}
      ...
      {report?.gaps?.length > 0 && (
        <div className="space-y-3">
          <h3 className="font-medium text-warm-800">Compassionate Insights</h3>
          ...
          <div className="space-y-2">
            {report.strengths.map(strength => (
              <div key={strength.value} className="flex items-center justify-between">
                <span className="text-sm text-green-700">{strength.label}</span>
